                                ...
                                stage('Set Up C++ Test Environment'){
                                    steps{
                                        ...
                                        sh(
                                            ...
                                            script: '''
                                                cmake -S . -B build/client -Wdev -DCMAKE_TOOLCHAIN_FILE:FILE=build/client/conan_paths.cmake -DCMAKE_POSITION_INDEPENDENT_CODE=OFF -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON
                                            '''
                                        )
                                        sh(
