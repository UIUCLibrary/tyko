                        ...
                        stage("PyTest"){
                            ...
                            steps{
                                dir("scm"){
                                    bat(
                                        label: "Run PyTest",
                                        script: "coverage run --parallel-mode --source=avforms,tests,setup.py -m pytest --junitxml=${WORKSPACE}/reports/pytest/junit-${env.NODE_NAME}-pytest.xml --junit-prefix=${env.NODE_NAME}-pytest"
                                    )
                                }
                            }
                            post {
